    ...
    public function run(): void
    {
        $movies = [
            ...
            [
                ...
                'genre' => json_encode(['Action', 'Sci-Fi']),
                'rate' => 8.7
            ],
            [
                ...
                'genre' => json_encode(['Adventure', 'Drama', 'Sci-Fi']),
                'rate' => 8.6
            ],
            [
            ...
            [
                ...
                'genre' => json_encode(['Animation', 'Adventure', 'Drama']),
                'rate' => 8.5
            ],
            [
            ...
            [
                ...
                'genre' => json_encode(['Adventure', 'Sci-Fi']),
                'rate' => 8.1
            ],
            [
            ...
            [
                ...
                'genre' => json_encode(['Biography', 'Drama']),
                'rate' => 7.7
            ],
            [
